  ...
  $.fn.animepng = function(settings) {
    ...
    return this.each(function(){
      ...
      if(settings.direction == "x"){
        base.css("background-size", settings.width * settings.length + "px " + settings.height + "px");
      }else{
        base.css("background-size", settings.width + "px " + settings.height * settings.length + "px");
      }
